...
class main_menu():
    ...
    def mod_win(self):
        ...
        ####################
        self.rb1=Radiobutton(wdw, textvariable=self.text1, variable=self.var1, value=0, bg='blue', font='Arial 15').place(x=350, y=540, height=60, width=220)
        self.rb2=Radiobutton(wdw, text='вариант ответа 2', variable=self.var1, value=1, bg='blue', font='Arial 15').place(x=800, y=540, height=60, width=220)
        self.rb3=Radiobutton(wdw, text='вариант ответа 3', variable=self.var1, value=2, bg='blue', font='Arial 15').place(x=350, y=630, height=60, width=220)
        self.rb4=Radiobutton(wdw, text='вариант ответа 4', variable=self.var1, value=3, bg='blue', font='Arial 15').place(x=800, y=630, height=60, width=220)
        ####################
